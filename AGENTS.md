...
4. `repo_manifest.yaml` and the nearest package documentation for ownership and navigation.
5. `docs/SPECIFICATIONS.md` and its linked focused documents for implementation contracts.
6. Tests and current code for executable evidence.
...
- Update tests and documentation with behavior changes. Do not create ADRs without explicit user approval.
